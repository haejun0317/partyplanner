      ...
      <table class="table">
        ...
        <tr>
          ...
          <tr>
            ...
            <textarea  name="content" id="contents" cols="30" rows="10" title="카페설명" name="content" id="content"vclass="input_txt3 __byte(1~100) __notnull"vmaxlength="200" style="width: 100%; margin-left: -75px"></textarea>
            </pre>
            </td>
          </tr>
